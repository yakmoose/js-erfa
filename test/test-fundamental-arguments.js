...
describe('Fundamental Arguments', function () {
    ...
    describe('#faom03()', function () {
        it("Should return a number in radians", function () {
            //vvd(eraFaom03(0.80), -5.973618440951302183, 1e-12, "eraFaom03", "", status);        var faom03 = fa.faom03(0.80);
            var faom03 = fa.faom03(0.80);
    ...
    describe('#fave03()', function () {
        it("Should return a number in radians", function () {
            //vvd(eraFave03(0.80), 3.424900460533758000, 1e-12, "eraFave03", "", status);            var fave03 = fa.fave03(0.80);
            var fave03 = fa.fave03(0.80);
